...
export function EditReserva({
                    ...
                    <div className="mt-2">
                      <form id='AntdV2'>
                          ...
                          <div className="flex justify-between">
                              <div>
                                <button onClick={(e)=>validarReserva(e)} className="text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm w-full sm:w-auto px-5 py-2.5 text-center dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800" >Alterar</button>
                              </div>
                              <div>
                                <button onClick={(e)=>apagarReserva(e)} className="text-white bg-red-700 hover:bg-red-800 focus:ring-4 focus:outline-none focus:ring-red-300 font-medium rounded-lg text-sm w-full sm:w-auto px-5 py-2.5 text-center dark:bg-red-600 dark:hover:bg-red-700 dark:focus:ring-red-800" >Apagar</button>
                              </div>
                          </div>
  ...
  function apagarReserva(e){
    const txt = 'Tem a certeza que quer remover a reserva de ' + utilizador + '?'
    Swal.fire({
      title: 'Atenção!',
      text: txt,
      ...
      if (result.isConfirmed) {
        ...
        axios.delete(urlBase() + "reservas/remover/" + id)
        .then(res => {
          closeModal()
          reloadTable()
          insertLogs('reserva', 'delete', utilizador)
        }).catch(error => {
          if(isDebugging()) console.log(error)
        })
