...
export function AddReserva({
  ...
  const [sala, setSala] = useState(nsala)
  ...
  useEffect(() => {
    setDataReserva(moment(inicio, dateFormat))
    setHoraInicio(moment(inicio, dateFormat))
    setHoraFim(moment(fim, dateFormat))
  }, [inicio, fim])

  const [dataReserva, setDataReserva] = useState(moment(inicio, dateFormat));
  const [horaInicio, setHoraInicio] = useState(moment(inicio, timeFormat));
  const [horaFim, setHoraFim] = useState(moment(fim, dateFormat));
